...
int CBetSite_18bet::AnalyzeBetREQ_GET_ODD()
{
	if (m_szTextBet == NULL || m_nTextSizeBet < 20)
		goto L_FALSE;
	WriteResData(_T("c:\\18bet.AnalyzeBetREQ_GET_ODD.json"), m_szTextBet);
	{
		Document root;
...
int CBetSite_18bet::AnalyzeBetREQ_UPDATE_BETSLIP(BetInfo* pBetInfo, int nBetObjNo, float& coeff)
{
	...
	if (m_szTextBet == NULL || m_nTextSizeBet < 20)
		goto L_FALSE;
	WriteResData(_T("c:\\18bet.AnalyzeBetREQ_UPDATE_BETSLIP.json"), m_szTextBet);
	{
		Document root;
		ParseResult ok = root.Parse(m_szTextBet);
		if (!ok)
...
int CBetSite_18bet::AnalyzeBetREQ_PLACE_BET()
{
	if (m_szTextBet == NULL || m_nTextSizeBet < 20)
		goto L_FALSE;
	WriteResData(_T("c:\\18bet.AnalyzeBetREQ_PLACE_BET.json"), m_szTextBet);
	{
		Document root;
		ParseResult ok = root.Parse(m_szTextBet);
		if (!ok)
...
BOOL CBetSite_18bet::AnalyzeBetREQ_REMOVE_ODD()
{
	...
	return TRUE;
L_FALSE:
	WriteResData(_T("c:\\18bet.AnalyzeBetREQ_REMOVE_ODD.json"), m_szTextBet);
	return FALSE;
}
...
BOOL CBetSite_18bet::AnalyzeResLogIn()
{
	...
	return TRUE;
L_FALSE:
	WriteResData(_T("c:\\18bet.AnalyzeResLogIn.json"), m_szText);
	return FALSE;
}
...
BOOL CBetSite_18bet::AnalyzeBetResBalance()
{
	...
	return TRUE;
L_FALSE:
	WriteResData(_T("c:\\18bet.AnalyzeBetResBalance.json"), m_szText);
	return FALSE;
}
...
BOOL CBetSite_18bet::AnalyzeResBalance()
{
	...
	return TRUE;
L_FALSE:
	WriteResData(_T("c:\\18bet.AnalyzeResBalance.json"), m_szText);
	return FALSE;
}
...
BOOL CBetSite_18bet::AnalyzeResData()
{
	if (m_szText == NULL || m_nTextSize < 20)
		goto L_FALSE;
	WriteResData(_T("c:\\18bet.AnalyzeResData.json"), m_szText);
	try
	{
		Document root;
		ParseResult ok = root.Parse(m_szText);

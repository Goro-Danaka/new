...
#ifdef NO_ENGINE
	if (pBetInfo->BetVal[nBetObjNo].nResult == BET_SUCCESS || pBetInfo->BetVal[nBetObjNo].nResult == BET_GAME_REMOVED || 
		pBetInfo->BetVal[nBetObjNo].nResult == BET_CHECK_EVENT_FAIL || pBetInfo->BetVal[nBetObjNo].nResult == BET_ODD_REMOVED)
#else
	if (pBetInfo->BetVal[nBetObjNo].nResult == BET_SUCCESS)
#endif
	{
